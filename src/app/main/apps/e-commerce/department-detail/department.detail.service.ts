...
@Injectable()
export class DepartmentDetailService implements Resolve<any>
{
    routeParams: any;
    department: any;
    ...
    getDepartment(): Promise<any>
    {
        return new Promise((resolve, reject) => {
            ...
            {
                this._httpClient.get('api/e-commerce-departments/' + this.routeParams.id)
    ...
    {
        return new Promise((resolve, reject) => {
            this._httpClient.post('api/e-commerce-departments/' + department.id, department)
                .subscribe((response: any) => {
                    resolve(response);
                }, reject);
        });
    ...
    {
        return new Promise((resolve, reject) => {
            this._httpClient.post('api/e-commerce-departments/', department)
                .subscribe((response: any) => {
                    resolve(response);
                }, reject);
        });
